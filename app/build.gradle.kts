...
android {
  namespace = "com.michael.storeclear"
  ...
  testOptions {
    unitTests {
      ...
      all {
        ...
        it.useJUnit {
          if (screenshotTests) {
            includeCategories("com.michael.storeclear.playstore.PlayStoreScreenshotTests")
          } else {
            excludeCategories("com.michael.storeclear.playstore.PlayStoreScreenshotTests")
          }
        }
      }
    }
